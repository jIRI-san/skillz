...
| [plugin-registry.design.md](architecture/plugin-registry.design.md) | `plugins/**`, `registry.json`, `scripts/skillz/**`, `schemas/{plugin,registry,receipt}.schema.json`, `.github/.skillz/**` | Plugin manifests, registry generation, transactional install/update/remove, dogfood sync, confinement and integrity model |
