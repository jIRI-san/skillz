...
| [autopilot-execution.design.md](architecture/autopilot-execution.design.md) | `plugins/autopilot/scripts/**`, `plugins/autopilot/devcontainer/**`, `plugins/autopilot/schemas/autopilot.schema.json`, `.github/agents/autopilot.agent.md`, `.autopilot.json` | Autonomous plan execution, host/container/sandbox modes, auth setup, trust boundaries, agent definition |
